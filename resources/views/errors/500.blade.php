...
<head>
    ...
    <title>Error del servidor | Fundación Centro de Bienestar del Anciano Nazareth</title>
...
<body class="bg-nazareth-paper font-sans antialiased min-h-screen flex flex-col items-center justify-center px-4">
    ...
    <div class="text-center max-w-md">
        ...
        <p class="text-6xl font-semibold text-nazareth-blue mb-4">500</p>
        <h1 class="text-2xl font-medium text-nazareth-ink mb-3">Error del servidor</h1>
